...
cp -a "../Juniper/Juniper/bin/Release/net5.0/linux-x64/." "$build_dir/usr/share/juniper/"
cp -a "../Juniper/Juniper/bin/Release/net5.0/linux-x64/juniper" "$build_dir/usr/bin/"
