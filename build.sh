...
cp -a "../Juniper/Juniper/bin/Release/net8.0/linux-x64/publish/." "$build_dir/usr/share/juniper/"
cp -a "../Juniper/Juniper/bin/Release/net8.0/linux-x64/juniper" "$build_dir/usr/bin/"
